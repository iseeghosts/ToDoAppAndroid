...
import Add_Note from './../assets/Add_Notes_Dark.png' //Image uri for Add note button
...
export default function AddNote(props){
    ...
    return(
        ...
        when clicked/touched triggers add_newtask function in UserHome  [add_newtask] */}
            <TouchableHighlight underlayColor={'darkgrey'} style={styles.addnotebutton} onPress={ () => props.onPress()}>
