...
import Profile_Image from './../assets/Profile_Pic_Light.png'  //sample profile logo
import Settings_User from './../assets/Settings_Icon_Light.png'   //settings icon
...
export default class WelcomeUser extends Component {
  ...
  profile_menu = () => {
      this.setState({
        ...
        'backColor':(this.state.profileMenu=='flex'?'transparent':'skyblue'),
