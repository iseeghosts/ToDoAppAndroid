...
//Importing functions
import SavedNote from '../components/SavedNoteLight'    //Function resposible for maintaining notes (editing, deleting, checking)
import WelcomeUser from '../components/WelcomeUserLight'  //Header for logged in user [View Profile] - incomplete, [settings] - incomplete
import AddNoteButton from '../components/AddNoteButtonLight'  //Button to add notes
import UserSettings from './UserSettingsLight'
...
export default class UserHome extends Component{
    ...
    add_newtask = () => {
        ...
        this.props.Tasks[this.props.id].push({"key":this.state.taskid, "content":"", "last_updated":date});   // Pushing new task to list of Tasks
